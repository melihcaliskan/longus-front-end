...
import { HomeDropdown, LoginModal } from '../Home/Header'
...
const HeaderDropdown = ({ userData, isAuth, t, isMobile, isLight, toggleTheme }) => {
            ...
            {!isAuth ?
                ...
                <CustomDropdown className="header-dropdown" as={Dropdown}>
                    <Dropdown.Toggle id="header">
                        ...
                        <ProfilePicture width="30px" height="30px" src={pp} />
                    </Dropdown.Toggle>
                    <Dropdown.Menu>
                        {isMobile ?
                            <>
                                ...
                                <Dropdown.Item onClick={() => setSearchModalShow(true)} >
                                    <Search />
                        ...
                        <Dropdown.Item href={`/profile/${userData.username}`}>
